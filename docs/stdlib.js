...
pub fn lazy_guard(
  ...
  "gleam/bytes_builder": `import gleam/bit_array
import gleam/list
...
pub fn subtract(a: Float, b: Float) -> Float {
  ...
  "gleam/function": `@deprecated("Use a fn literal instead, it is easier to understand")
...
fn do_debug_println(string string: String) -> Nil`,
  "gleam/iterator": `import gleam/dict.{type Dict}
import gleam/int
import gleam/list
